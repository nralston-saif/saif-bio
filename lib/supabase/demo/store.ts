...
function buildSeedTables(): Record<string, Row[]> {
  return {
    ...
    bio_contacts: [
      { id: ids.donorJane, contact_type: 'individual', display_name: 'Jane Donor', org_name: null, first_name: 'Jane', last_name: 'Donor', email: 'jane.donor@example.com', phone: '415-555-0101', address_line1: '1 Main St', address_line2: null, city: 'Oakland', state: 'CA', postal_code: '94601', country: 'US', tax_id: null, tax_status: null, is_donor: true, is_grantee: false, is_funder: false, is_vendor: false, w9_on_file: false, notes: null, ...ts('2026-01-12') },
      { id: ids.donorAcmeFdn, contact_type: 'organization', display_name: 'Acme Family Foundation', org_name: 'Acme Family Foundation', first_name: null, last_name: null, email: 'grants@acmefamily.example.org', phone: null, address_line1: '200 Park Ave', address_line2: null, city: 'New York', state: 'NY', postal_code: '10166', country: 'US', tax_id: '13-7654321', tax_status: null, is_donor: true, is_grantee: false, is_funder: true, is_vendor: false, w9_on_file: false, notes: 'Family foundation interested in biosecurity.', ...ts('2026-01-20') },
      { id: ids.granteeLab, contact_type: 'organization', display_name: 'BioSafety Lab Collective', org_name: 'BioSafety Lab Collective', first_name: null, last_name: null, email: 'grants@biosafetylab.example.org', phone: null, address_line1: '77 Research Way', address_line2: null, city: 'Boston', state: 'MA', postal_code: '02115', country: 'US', tax_id: '98-7654321', tax_status: '501c3_public_charity', is_donor: false, is_grantee: true, is_funder: false, is_vendor: false, w9_on_file: false, notes: null, ...ts('2026-02-01') },
      { id: ids.granteeWatch, contact_type: 'organization', display_name: 'Pandemic Watch Institute', org_name: 'Pandemic Watch Institute', first_name: null, last_name: null, email: 'office@pandemicwatch.example.org', phone: null, address_line1: '9 Hill Rd', address_line2: null, city: 'Seattle', state: 'WA', postal_code: '98101', country: 'US', tax_id: '91-1122334', tax_status: '501c3_public_charity', is_donor: false, is_grantee: true, is_funder: false, is_vendor: false, w9_on_file: false, notes: null, ...ts('2026-03-10') },
      { id: ids.funderOpen, contact_type: 'organization', display_name: 'Open Philanthropy Example Fund', org_name: 'Open Philanthropy Example Fund', first_name: null, last_name: null, email: 'programs@opef.example.org', phone: null, address_line1: null, address_line2: null, city: 'San Francisco', state: 'CA', postal_code: null, country: 'US', tax_id: null, tax_status: null, is_donor: false, is_grantee: false, is_funder: true, is_vendor: false, w9_on_file: false, notes: null, ...ts('2026-02-15') },
      { id: ids.vendorAcct, contact_type: 'organization', display_name: 'Acme Accounting LLP', org_name: 'Acme Accounting LLP', first_name: null, last_name: null, email: 'billing@acmeacct.example.com', phone: null, address_line1: null, address_line2: null, city: 'San Francisco', state: 'CA', postal_code: null, country: 'US', tax_id: '11-2233445', tax_status: null, is_donor: false, is_grantee: false, is_funder: false, is_vendor: true, w9_on_file: true, notes: null, ...ts('2026-01-15') },
    ],
    bio_contributions: [
      { id: ids.contribution1, contact_id: ids.donorJane, amount_cents: 250_000, received_date: '2026-03-15', method: 'wire', vehicle: 'daf', vehicle_sponsor_name: 'Fidelity Charitable', in_kind_description: null, restriction: 'unrestricted', restriction_purpose: null, quid_pro_quo: false, goods_services_description: null, goods_services_value_cents: null, check_number: null, notes: null, entered_by: ids.nick, ...ts('2026-03-15') },
      { id: ids.contribution2, contact_id: ids.donorJane, amount_cents: 50_000, received_date: '2026-05-01', method: 'check', vehicle: 'direct', vehicle_sponsor_name: null, in_kind_description: null, restriction: 'unrestricted', restriction_purpose: null, quid_pro_quo: true, goods_services_description: 'two fundraising dinner tickets', goods_services_value_cents: 15_000, check_number: '1042', notes: null, entered_by: ids.mike, ...ts('2026-05-01') },
      { id: ids.contribution3, contact_id: ids.donorAcmeFdn, amount_cents: 5_000_000, received_date: '2026-04-20', method: 'ach', vehicle: 'private_foundation', vehicle_sponsor_name: null, in_kind_description: null, restriction: 'donor_restricted', restriction_purpose: 'Biosafety training programs', quid_pro_quo: false, goods_services_description: null, goods_services_value_cents: null, check_number: null, notes: null, entered_by: ids.nick, ...ts('2026-04-20') },
      { id: ids.contribution4, contact_id: ids.donorJane, amount_cents: 197_850, received_date: '2026-06-03', method: 'stock', vehicle: 'direct', vehicle_sponsor_name: null, in_kind_description: null, restriction: 'unrestricted', restriction_purpose: null, quid_pro_quo: false, goods_services_description: null, goods_services_value_cents: null, check_number: null, notes: 'Demo stock gift with internal FMV from broker statement.', entered_by: ids.nick, ...ts('2026-06-03') },
    ],
    ...
    bio_grant_proposals: [
      { id: ids.proposal1, applicant_contact_id: ids.granteeLab, title: 'Community biosafety training program', summary: 'Twelve-month training program for community lab biosafety officers across 20 cities.', pillars: ['detect', 'prevent'], amount_requested_cents: 5_000_000, received_date: '2026-03-01', entered_date: '2026-03-01', source: 'email', status: 'decided', decision: 'approved', decision_date: '2026-04-15', decision_notes: 'Strong team, clear milestones. Approved at requested amount less travel line.', ...ts('2026-03-01') },
      { id: ids.proposal2, applicant_contact_id: ids.granteeWatch, title: 'Open wastewater surveillance dashboard', summary: 'Public dashboard aggregating municipal wastewater pathogen signals with open methodology.', pillars: ['detect'], amount_requested_cents: 7_500_000, received_date: '2026-05-20', entered_date: '2026-05-20', source: 'referral', status: 'in_review', decision: null, decision_date: null, decision_notes: null, ...ts('2026-05-20') },
    ],
