...
- **Contributions** — record donations (cash, stock, crypto, in-kind), track stock-gift FMV/security/sale details, generate and email IRS Pub 1771-compliant acknowledgement letters (PDF via @react-pdf/renderer, email via Resend)
...
| Email | Resend |
| Market data | Optional Financial Modeling Prep key for cached stock EOD prices |
